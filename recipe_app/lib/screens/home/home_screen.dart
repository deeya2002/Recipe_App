...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> refresh() async {
    ...
    _recipeViewModel.getrecipes();
    _authViewModel.getMyrecipes();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer3<CategoryViewModel, AuthViewModel, recipeViewModel>(
        builder: (context, categoryVM, authVM, recipeVM, child) {
      return Container(
        child: Stack(
          children: [
            Positioned.fill(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: GridView.count(
                            ...
                            crossAxisCount: 2,
                            children: [
                              ...recipeVM.recipes.map((e) => recipeCard(e))
                            ],
                          ),
                        ),
                      ],
  ...
  Widget recipeCard(RecipeModel e) {
    return InkWell(
      onTap: () {
        // print(e.id);
                ...
                child: Align(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            e.recipeName.toString(),
                            style: TextStyle(fontSize: 20),
                            textAlign: TextAlign.center,
                            maxLines: 2,
                          ),
                          Text(
                            "Min "+e.recipePrice.toString(),
